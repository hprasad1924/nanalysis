...
class event:public TObject
{
	public:
		...
		bool flag_2p2h;		/// incase mec_kind = Nieves store whether the event is 2p2h dynamics(true) or 3p3h dynamics(false). Default value is 2p2h (true).
		...
		event ():weight(0), flag_2p2h(true), norm(1){}///< default constructor
